...
import lk.ijse.thogakade.model.ItemRepository;
import lk.ijse.thogakade.model.OrderRepository;
import lk.ijse.thogakade.model.PlaceOrderRepository;
...
public class PlaceOrderFormController implements Initializable {
    ...
    void btnPlaceOrderOnAction(ActionEvent event) {
        ...
        try {
            boolean isPlaced = PlaceOrderRepository.placeOrder(placeOrder);
            if (isPlaced) {
                /* to clear table */
                obList.clear();
                loadNextOrderId();
    ...
    private void loadCustomerIds() {
        try {
            ...
            ArrayList<String> idList = CustomerRepository.loadCustomerIds();
    ...
    private void loadItemCodes() {
        try {
            ObservableList<String> observableList = FXCollections.observableArrayList();
            ArrayList<String> itemList = ItemRepository.loadItemCodes();
    ...
    void cmbItemOnAction(ActionEvent event) {
        String code = String.valueOf(cmbItemCode.getValue());
        try {
            Item item = itemRepository.search(code);
            fillItemFields(item);
            txtQty.requestFocus();
        } catch (SQLException | ClassNotFoundException e) {
            throw new RuntimeException(e);
